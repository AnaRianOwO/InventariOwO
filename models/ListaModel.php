<?php
	...
	class Lista_model {
		...
		public function insertar_producto($nombreProducto, $descripcionProducto, $marca, $lugarDeCompra, $fechaVencimiento, $idPresentacion, $stock, $idCategoria, $idPrioridad, $precio){
			...
			$sql = "INSERT INTO producto (nombreProducto, descripcionProducto, marca, lugarDeCompra, fechaVencimiento, idPresentacion, stock, idCategoria, idPrioridad, precio, estado) VALUES ('$nombreProducto', '$descripcionProducto', '$fechaVencimiento', '$idPresentacion', '$stock', '$idCategoria', '$idPrioridad', '$precio', 1)";
			$resultado = $this->db->query($sql);
