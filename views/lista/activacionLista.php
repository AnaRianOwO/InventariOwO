				...
				<thead class="thead-dark">
					...
					<tbody>
						<?php foreach($data["producto"] as $dato) {
							...
							echo "<td><a href='index.php?c=producto&a=activar&id=".$dato["idProducto"]."' class='btn activar'>Activar</a></td>";
							echo "<td><a href='index.php?c=producto&a=eliminar&id=".$dato["idProducto"]."' class='btn eliminar'>Eliminar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
