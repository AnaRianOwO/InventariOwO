...
<html lang="es">
	...
	<body>
		...
		<div class="containertab">
			...
			<a href="index.php?c=producto&a=nuevo" class="btn agregar">Agregar</a>
			<br />
			<br />
				...
				<table border = "1" width="80%" class="table display" name="productos" id="productos">
					...
					<tbody>
						<?php foreach($data["producto"] as $dato) {
							...
							echo "<td><a href='index.php?c=producto&a=modificar&id=".$dato["idProducto"]."' class='btn modificar'>Modificar</a></td>";
							echo "<td><a href='#' onclick='borrar()' class='btn desactivar' onclick='borrar()'>Desactivar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
			...
			<a href="index.php?c=producto&a=activacion" class="btn desactivados">Productos desactivados</a>
		</div>
