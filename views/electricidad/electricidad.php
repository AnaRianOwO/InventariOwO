...
<html lang="es">
	...
	<body>
		...
		<div class="containertab">
			...
			<a href="?c=electricidad&a=nuevo" class="btn agregar">Agregar</a>
			<br />
			<br />
			<div class="table-responsive">
				<table border = "1" width="80%" class="table display" name="electricidad" id="electricidad">
					...
					<tbody>
						<?php foreach($data["electricidad"] as $dato) {
							...
							echo "<td>".$dato["consumo"]." kWh</td>";
							echo "<td>".$dato["fechaPago"]."</td>";
							echo "<td><a href='?c=electricidad&a=modificar&id=".$dato["idRecibo"]."' class='btn modificar'>Modificar</a></td>";
							echo "<td><a href='?c=electricidad&a=desactivar&id=".$dato["idRecibo"]."' class='btn agregar'>Pagado</a></td>";
			...
			<a href="?c=electricidad&a=activacion" class="btn desactivados">Recibos pagados</a>
		</div>
