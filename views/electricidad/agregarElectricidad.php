...
<html lang="es">
	...
	<body>
		...
		<?php echo $data["titulo"]; ?>
			...
			<div class= "form">
				<form id="nuevo" name="nuevo" method="POST" action="?c=electricidad&a=guarda" autocomplete="off">
					...
					<div class="form-group campo_input">
						...
						<input type="textarea" class="form-control textarea" id="consumo" name="consumo" placeholder="kWh" required></textarea>
					</div>
