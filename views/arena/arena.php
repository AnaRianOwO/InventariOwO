...
<html lang="es">
	...
	<body>
		...
		<div class="containertab">
			...
			<a href="?c=arena&a=nuevo" class="btn agregar">Agregar</a>
			<br />
			<br />
			<div class="table-responsive">
				<table border = "1" width="80%" class="table display" name="arenas" id="arenas">
					...
					<tbody>
						<?php foreach($data["arena"] as $dato) {
							echo "<tr>";
							echo "<td> $".$dato["totalArena"]."</td>";
							echo "<td>".$dato["cantidadArena"]." lonadas</td>";
							echo "<td>".$dato["fechaCompra"]."</td>";
							echo "<td>".$dato["fechaTerminacion"]."</td>";
							echo "<td><a href='?c=arena&a=modificar&id=".$dato["idArenaCats"]."' class='btn modificar'>Modificar</a></td>";
							echo "<td><a href='?c=arena&a=eliminar&id=".$dato["idArenaCats"]."' class='btn eliminar'>Eliminar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
