...
<html lang="es">
	...
	<body>
		...
		<div class="containertab">
			...
			<a href="?c=internet&a=nuevo" class="btn agregar">Agregar</a>
			<br />
			<br />
			<div class="table-responsive">
				<table border = "1" width="80%" class="table display" name="internet" id="internet">
					...
					<tbody>
						<?php foreach($data["internet"] as $dato) {
							echo "<tr>";
							echo "<td>".$dato["valorRecibo"]."</td>";
							echo "<td>".$dato["consumo"]."</td>";
							echo "<td>".$dato["fechaPago"]."</td>";
							echo "<td><a href='?c=internet&a=modificar&id=".$dato["idRecibo"]."' class='btn modificar'>Modificar</a></td>";
							echo "<td><a href='?c=internet&a=desactivar&id=".$dato["idRecibo"]."' class='btn agregar'>Pagado</a></td>";
							echo "<td><a href='?c=internet&a=eliminar&id=".$dato["idRecibo"]."' class='btn eliminar'>Eliminar</a></td>";
							echo "</tr>";
						}
						?>
					</tbody>
			...
			<a href="?c=internet&a=activacion" class="btn desactivados">Recibos pagados</a>
		</div>
